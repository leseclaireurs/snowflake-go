...
const (
	// 开始时间戳 (2020-10-11 12:00:00)
	epoch uint64 = 1602388800000
...
func (r *SnowFlake) NextID() uint64 {
	...
	return ((timestamp - epoch) << timestampLeftShift) | (r.datacenterID << datacenterIdShift) | (r.workerID << workerIdShift) | r.sequence
}
